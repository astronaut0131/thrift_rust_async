...
impl<IP, OP> TThriftClient for CalculatorSyncClient<IP, OP> where IP: TInputProtocol + Send, OP: TOutputProtocol + Send {
    fn i_prot_mut(&mut self) -> &mut (dyn TInputProtocol + Send) { &mut self._i_prot }
    fn o_prot_mut(&mut self) -> &mut (dyn TOutputProtocol + Send) { &mut self._o_prot }
...
impl<H: CalculatorSyncHandler + Send> CalculatorSyncProcessor<H> {
    ...
    async fn process_add(&self, incoming_sequence_number: i32, i_prot: &mut (dyn TInputProtocol + Send), o_prot: &mut (dyn TOutputProtocol + Send)) -> thrift::Result<()> {
...
impl TCalculatorProcessFunctions {
    pub async fn process_add<H: CalculatorSyncHandler>(handler: &H, incoming_sequence_number: i32, i_prot: &mut (dyn TInputProtocol + Send), o_prot: &mut (dyn TOutputProtocol + Send)) -> thrift::Result<()> {
...
#[async_trait]
impl<H: CalculatorSyncHandler + Send + Sync> TProcessor for CalculatorSyncProcessor<H> {
    async fn process(&self, i_prot: &mut (dyn TInputProtocol + Send), o_prot: &mut (dyn TOutputProtocol + Send)) -> thrift::Result<()> {
...
impl AddArgs {
    async fn read_from_in_protocol(i_prot: &mut (dyn TInputProtocol + Send)) -> thrift::Result<AddArgs> {
    ...
    async fn write_to_out_protocol(&self, o_prot: &mut (dyn TOutputProtocol + Send)) -> thrift::Result<()> {
...
impl AddResult {
    async fn read_from_in_protocol(i_prot: &mut (dyn TInputProtocol + Send)) -> thrift::Result<AddResult> {
        i_prot.read_struct_begin().await?;
