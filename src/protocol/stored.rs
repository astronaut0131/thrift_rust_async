...
pub struct TStoredInputProtocol<'a> {
    inner: &'a mut (dyn TInputProtocol + Send),
...
impl<'a> TStoredInputProtocol<'a> {
    ...
    pub fn new(
        wrapped: &mut (dyn TInputProtocol + Send),
